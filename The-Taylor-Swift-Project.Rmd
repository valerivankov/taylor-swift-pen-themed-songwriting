...
suppressWarnings(library(spotifyr))
suppressWarnings(library(rvest))
suppressWarnings(library(quanteda))
suppressWarnings(library(quanteda.corpora))
suppressWarnings(library(quanteda.textplots))
suppressWarnings(library(quanteda.textstats))
suppressWarnings(library(readtext))
suppressWarnings(library(syuzhet))
suppressWarnings(library(FactoMineR))
suppressWarnings(library(proxy))
